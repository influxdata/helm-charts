...
otherwise Helm continues deploying the overridden image.
...
the InfluxDB version in the chart's `appVersion`. Query existing data and test a new write before starting the
